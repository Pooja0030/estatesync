    ...
    <div className="h-screen overflow-hidden bg-gray-100 flex">
      ...
      <aside className="w-64 flex-shrink-0 bg-dark-800 text-white flex flex-col h-full overflow-y-auto">
        ...
        <nav className="flex-1 p-4 space-y-2">
          <Link to={getDashboardLink()} className="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-700 transition">
        ...
        <div className="p-4 border-t border-gray-700">
          ...
          <button 
            ...
            className="flex items-center justify-center w-full space-x-2 bg-red-600 hover:bg-red-700 p-2 rounded-lg transition"
          >
            <LogOut size={18} />
            <span>Logout</span>
          </button>
      ...
      {showLogoutModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4 backdrop-blur-sm">
          <div className="bg-white rounded-xl shadow-2xl p-6 max-w-sm w-full animate-fade-in text-gray-800">
